...
namespace MvcApp
{
    class Startup : IMvcApplication
    {
        ...
        public void Configure(List<Route> routeTable)
        {
            ...
            routeTable.Add(new Route("/css/bootstrap.min.css", HttpMethod.Get, new StaticFilesController().BootstapCss));
            routeTable.Add(new Route("/js/bootstrap.bundle.min.js", HttpMethod.Get, new StaticFilesController().BootstapJs));
